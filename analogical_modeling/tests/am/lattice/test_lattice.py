...
class LatticeTest(unittest.TestCase):
    ...
    def do_test_supras(self, train: Dataset, test_index: int, expected_supras: list[str], lattice_supplier):
        """Test that the given test/train combination yields the given list of supracontexts.
        ...
        sub_list = SubcontextList(self.get_full_split_labeler(test), train, False)
